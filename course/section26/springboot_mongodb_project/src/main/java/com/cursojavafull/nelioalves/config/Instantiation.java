...
import com.cursojavafull.nelioalves.dto.AuthorDTO;
import com.cursojavafull.nelioalves.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Post post2 = new Post(null, sdf.parse("23/03/2018"), "Bom dia Pessoal", "Acordei feliz hoje!!!", new AuthorDTO(maria));
